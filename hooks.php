 ...
 * 
 * @package KsfFA_ksf_FA_DynamicPricing
 * @version 2.4.3
 */

define('SS_ksf_FA_DynamicPricing', 128 << 8);
...
class hooks_ksf_FA_DynamicPricing extends hooks {
    ...
    function install_tabs($app) {
        ...
        // return new ksf_FA_DynamicPricing_app();
    }
    ...
    function install_access() {
        ...
        $security_areas['SA_ksf_FA_DynamicPricingVIEW'] = array(
            SS_ksf_FA_DynamicPricing | 1, 
            _("View ")
        );
        $security_areas['SA_ksf_FA_DynamicPricingMANAGE'] = array(
            SS_ksf_FA_DynamicPricing | 2, 
            _("Manage ")
        );
